...
# Mostrar total de las solicitudes registradas
if 'lista_solicitudes' in st.session_state:
    total_monto = sum([solicitud['Precio'] for solicitud in st.session_state['lista_solicitudes']])
    st.markdown(f"**Monto total de las solicitudes registradas: Q{total_monto:,.2f}**")
