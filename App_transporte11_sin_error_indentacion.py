...
if st.button("Registrar solicitud") and 'ultima_solicitud' not in st.session_state:
    nueva = {
    ...
    if st.session_state.solicitudes == [] or nueva != st.session_state.solicitudes[-1]:
        st.session_state.solicitudes.append(nueva)
        st.session_state.ultima_solicitud = nueva
        "Origen": "Sede Alamos zona seis San Miguel Petapa",
        "Destino": destino,
        "Tipo de camión": tipo_camion,
        "Precio": precio,
