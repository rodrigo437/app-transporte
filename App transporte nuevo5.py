...
departamentos = [
    ...
    "Jalapa", "Jutiapa", "Jalapa", "Zacapa", "Chiquimula", "Izabal", "Petén", "El Progreso",
    "Baja Verapaz", "Alta Verapaz"
]
tipos_camion = ["5 toneladas", "10 toneladas"]

departamento = st.selectbox("Departamento de destino", departamentos)
tipo_camion = st.selectbox("Tipo de camión", tipos_camion)
