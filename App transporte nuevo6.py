...
origen = st.text_input("Origen", value="Zona 6 San Miguel Petapa")

# Selección de destino y camión
departamentos = [
    "Guatemala", "Escuintla", "Sacatepéquez", "Chimaltenango", "Santa Rosa", "Quetzaltenango",
    "Retalhuleu", "Suchitepéquez", "San Marcos", "Huehuetenango", "Totonicapán", "Sololá",
    "Jalapa", "Jutiapa", "Zacapa", "Chiquimula", "Izabal", "Petén", "El Progreso",
    "Baja Verapaz", "Alta Verapaz", "Amatitlán"
]
tipos_camion = ["5T", "10T"]

departamento = st.selectbox("Selecciona el destino", departamentos)
tipo_camion = st.radio("Selecciona el tipo de camión", tipos_camion)
...
# Mostrar resumen si hay solicitudes
