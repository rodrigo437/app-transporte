...
if st.session_state.solicitudes:
    ...
    for i, solicitud in enumerate(st.session_state.solicitudes, 1):
        st.markdown(f"### Solicitud #{i}")
        st.markdown(f"- **Origen:** {solicitud['Origen']}")
        st.markdown(f"- **Destino:** {solicitud['Destino']}")
        st.markdown(f"- **Tipo de camión:** {solicitud['Tipo de camión']}")
        st.markdown(f"- **Precio:** Q{solicitud['Precio']:,}")
        st.markdown(f"- **Fecha y hora de recolección:** {solicitud['Fecha recolección']}")
        st.markdown(f"- **Fecha y hora de entrega:** {solicitud['Fecha entrega']}")
        st.markdown(f"- **Observaciones:** {solicitud['Observaciones']}")
