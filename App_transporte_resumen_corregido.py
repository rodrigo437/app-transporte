...
""")
        ...
        total_q += solicitud["Precio"]

    st.markdown(f"**Total acumulado en Quetzales:** Q{total_q:,.2f}") en Quetzales:** Q{total_q:,.2f}") en Quetzales:** Q{total_q:,.2f}")(s["Precio"] for s in st.session_state.solicitudes)
