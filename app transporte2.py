...
tarifario = {
    ...
    "Sololá": (180, 3100),
    "Teculután, Zacapa": (200, 3350),
    "San Benito": (480, 6200),
    "San Marcos": (260, 4100),
    "San Miguel Petapa": (30, 1500),
    "Quiché": (300, 4500),
    "Retalhuleu": (230, 3650),
    "Salamá": (215, 3550),
    "Poptún, Petén": (520, 6600),
    "Puerto Barrios": (370, 5000),
    "Quetzaltenango": (263, 4148),
    "Mazatenango": (210, 3400),
    "Mixco": (25, 1450),
    "Pajapita, San Marcos": (270, 4200),
    "Jalapa": (240, 3800),
    "La Libertad, Petén": (540, 6800),
    "Malacatán, San Marcos": (285, 4300),
    "El Chal, Petén": (500, 6400),
    "Escuintla": (111, 2150),
    "Huehuetenango": (275, 4200),
    "Chiquimula": (200, 3300),
    "Ciudad Capital": (0, 1300),
    "Cobán": (230, 3600),
    "Amatitlán": (35, 1500),
    "Asunción Mita, Jutiapa": (270, 4100),
    "Chimaltenango": (130, 2500)
}
...
def registrar_solicitud(cliente):
    ...
    cliente_entrega = st.text_input("Nombre del cliente de entrega")
    fecha_entrega = st.date_input("Fecha máxima de entrega")
    ...
    precio = tarifario[destino][1] if tipo_camion == "5T" else tarifario[destino][1] + 600
    km_total = km * 2
    ...
    if df_cliente.empty:
        ...
        for idx, row in df_cliente.iterrows():
            with st.expander(f"{row['Destino']} - Estado: {row['Estado']}"):
                ...
                st.write(f"Cliente entrega: {row['Cliente entrega']}")
